...
const _marko_componentType$2 = "src/__tests__/fixtures/static-adapter-page/src/routes/+page.marko",
...
const _marko_componentType$1 = "src/__tests__/fixtures/static-adapter-page/__marko-run__route.marko",
...
const _marko_componentType = "src/__tests__/fixtures/static-adapter-page/__marko-run__route.entry.marko",
  _marko_template = t(_marko_componentType);
const _marko_component = {};
_marko_template._ = _marko_renderer(function (input, out, _componentDef, _component, state, $global) {
  const g = out.global;
  const writeSync = addAssets(g, ["__marko-run__route_XCs-"]);
  if (writeSync) {
...
export { fetch };
;var __MARKO_MANIFEST__={"__marko-run__route_XCs-":{"head-prepend":null,"head":null,"body-prepend":null,"body":null}};
