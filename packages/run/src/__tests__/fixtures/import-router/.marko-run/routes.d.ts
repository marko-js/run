...
declare module "../src/routes/+middleware" {
  ...
  namespace MarkoRun {
    ...
    export type Route = $.Routes["/" | "/a" | "/api" | "/b" | "/c"];
...
declare module "../src/routes/+layout.marko" {
  ...
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    /** @deprecated use the `Run` namespace instead */
    export type Route = $.Routes["/" | "/a" | "/b" | "/c"];
    /** @deprecated use `Run.Context` instead */
...
type P4 = $.Template<"P4", typeof import("../src/routes/c/+page.marko")>;
declare module "../src/routes/c/+page.marko" {
