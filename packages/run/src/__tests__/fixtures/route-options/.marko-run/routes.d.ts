...
type H1 = $.Handler<"H1", typeof import("../src/routes/foo.$id/+handler")>;
declare module "../src/routes/foo.$id/+handler" {
...
type P1 = $.Template<"P1", typeof import("../src/routes/foo.$id/+page.marko")>;
