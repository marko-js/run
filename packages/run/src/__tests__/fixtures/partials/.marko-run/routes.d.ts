...
declare module "../src/routes/+layout.marko" {
  ...
  namespace MarkoRun {
    ...
    export type Route = $.Routes["/" | "/docs/$id"];
...
type P2 = $.Template<"P2", typeof import("../src/routes/docs/$id/+page.marko")>;
declare module "../src/routes/docs/$id/+page.marko" {
...
declare module "../src/routes/+404.marko" {
  export interface Input extends $.PageInput<S1, [T1]> {}
...
type T3 = $.PartialTemplate<"T3", "aside", typeof import("../src/routes/docs/@aside.marko")>;
declare module "../src/routes/docs/@aside.marko" {
