...
type T1 = $.PartialTemplate<"T1", "side-bar", typeof import("../src/routes/@side-bar.marko")>;
declare module "../src/routes/@side-bar.marko" {
...
type T2 = $.PartialTemplate<"T2", "side_bar", typeof import("../src/routes/@side_bar.marko")>;
declare module "../src/routes/@side_bar.marko" {
