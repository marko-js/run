		...
		switch (method) {
			...
			case 'get': {
				if (len > 1) {
					...
					if (i1 && i1 !== len) {
						if (pathname.slice(1, i1 - 1) === "docs") {
							const i2 = pathname.indexOf('/', 6) + 1;
							if (!i2 || i2 === len) {
								const s2 = decodeURIComponent(pathname.slice(6, i2 ? -1 : len));
								if (s2) return { handler: get1, path: "/docs/$slug", params: { slug: s2 }, options: get1_options, meta: {} };
							}
						}
					}
				}
				...
				if (len > 1) {
					...
					if (i1 && i1 !== len) {
						if (pathname.slice(1, i1 - 1) === "docs") {
							...
							if (!i2 || i2 === len) {
								const s2 = decodeURIComponent(pathname.slice(6, i2 ? -1 : len));
								if (s2) return { handler: head1, path: "/docs/$slug", params: { slug: s2 }, options: head1_options, meta: {} };
							}
						}
					}
				}
