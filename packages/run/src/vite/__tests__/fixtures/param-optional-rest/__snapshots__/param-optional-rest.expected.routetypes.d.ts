...
type P1 = $.Template<"P1", typeof import("../src/routes/$campaignId/$$rest,/+page.marko")>;
declare module "../src/routes/$campaignId/$$rest,/+page.marko" {
  ...
  namespace MarkoRun {
    ...
    export type Route = $.Routes["/$campaignId" | "/$campaignId/$$rest"];
