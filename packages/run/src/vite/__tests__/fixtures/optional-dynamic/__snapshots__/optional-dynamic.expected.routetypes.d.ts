...
type P1 = $.Template<"P1", typeof import("../src/routes/$foo,/$bar,$$rest/+page.marko")>;
declare module "../src/routes/$foo,/$bar,$$rest/+page.marko" {
  ...
  namespace MarkoRun {
    ...
    export type Route = $.Routes["/$foo/$bar" | "/$foo/$$rest" | "/$bar" | "/$$rest"];
