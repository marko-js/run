...
declare module "../src/routes/+layout.marko" {
  ...
  namespace MarkoRun {
    ...
    export type Route = $.Routes["/docs/$id" | "/blog/$id"];
...
type P1 = $.Template<"P1", typeof import("../src/routes/(docs,blog)/$id/+page.marko")>;
declare module "../src/routes/(docs,blog)/$id/+page.marko" {
...
type T1 = $.PartialTemplate<"T1", "header", typeof import("../src/routes/docs/@header.marko")>;
...
type T2 = $.PartialTemplate<"T2", "header", typeof import("../src/routes/(docs,blog)/$id/@header.marko")>;
declare module "../src/routes/(docs,blog)/$id/@header.marko" {
  interface Input extends Partial<$.PartialInput<T2>> {}
