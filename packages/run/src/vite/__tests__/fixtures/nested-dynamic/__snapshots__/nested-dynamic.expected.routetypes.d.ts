...
declare module "@marko/run" {
	interface App extends $.DefineRoutes<{
		"/foo/$fooId/bar/$bar_Id/baz/$1bazId/$qux-Id": [P1];
	}> {}
}

type P1 = $.Template<"P1", typeof import("../src/routes/foo/$fooId/bar/$bar_Id/baz/$1bazId/$qux-Id/+page.marko")>;
declare module "../src/routes/foo/$fooId/bar/$bar_Id/baz/$1bazId/$qux-Id/+page.marko" {
  ...
  namespace MarkoRun {
    ...
    export type Route = $.Routes["/foo/$fooId/bar/$bar_Id/baz/$1bazId/$qux-Id"];
