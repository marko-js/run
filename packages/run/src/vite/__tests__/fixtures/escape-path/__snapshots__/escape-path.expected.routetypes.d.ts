...
type P1 = $.Template<"P1", typeof import("../src/routes/`a?b`/$`$id`/$foo/+page.marko")>;
declare module "../src/routes/`a?b`/$`$id`/$foo/+page.marko" {
  ...
  namespace MarkoRun {
    ...
    export type Route = $.Routes["/a%3fb/$`$id`/$foo"];
...
type P2 = $.Template<"P2", typeof import("../src/routes/`a?b`/baz/+page.marko")>;
declare module "../src/routes/`a?b`/baz/+page.marko" {
  ...
  namespace MarkoRun {
    export { NotHandled, NotMatched, GetPaths, PostPaths, GetablePath, GetableHref, PostablePath, PostableHref, Platform };
    /** @deprecated use the `Run` namespace instead */
    export type Route = $.Routes["/a%3fb/baz"];
    /** @deprecated use `Run.Context` instead */
    export type Context = Run.Context;
    /** @deprecated define handlers with `Run.GET(...)`, `Run.POST(...)`, etc. instead */
    export type Handler = $.HandlerLike<Route>;
