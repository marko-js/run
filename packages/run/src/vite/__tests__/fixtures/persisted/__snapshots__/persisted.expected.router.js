...
import { get3, get3_options, head3, head3_options } from "virtual:marko-run/__marko-run__item.new.js";
import { get4, get4_options, head4, head4_options } from "virtual:marko-run/__marko-run__item.$.js";
import { get5, get5_options, head5, head5_options } from "virtual:marko-run/__marko-run__docs.intro.js";
import { get6, get6_options, head6, head6_options } from "virtual:marko-run/__marko-run__docs.$$.js";
			...
			if (i1 && i1 !== len) {
				switch (pathname.slice(1, i1 - 1)) {
					...
					case 'docs': {
						...
						return { handler: get6, i: 6, path: '/docs/$$rest', params: { rest: decodeURIComponent(pathname.slice(6)) }, options: get6_options, meta: {} };
					} break;
				}
			}
			return null;
			...
			if (i1 && i1 !== len) {
				switch (pathname.slice(1, i1 - 1)) {
					...
					case 'docs': {
						...
						return { handler: head6, i: 6, path: '/docs/$$rest', params: { rest: decodeURIComponent(pathname.slice(6)) }, options: head6_options, meta: {} };
					} break;
				}
			}
			return null;
