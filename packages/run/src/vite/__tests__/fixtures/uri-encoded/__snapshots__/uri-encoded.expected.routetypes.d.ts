...
declare module "@marko/run" {
	interface App extends $.DefineRoutes<{
		"/a%2fb%3fc%23d+e:f&g/$`$id`": [P1];
	}> {}
}

type P1 = $.Template<"P1", typeof import("../src/routes/a%2Fb?c#d+e:f%26g/$%24id/+page.marko")>;
declare module "../src/routes/a%2Fb?c#d+e:f%26g/$%24id/+page.marko" {
  ...
  namespace MarkoRun {
    ...
    export type Route = $.Routes["/a%2fb%3fc%23d+e:f&g/$`$id`"];
